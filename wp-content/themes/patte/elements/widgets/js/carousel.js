(function($) {
    ...
    var pxl_swiper_handler = function($scope, $) {
        ...
        /* Arrow Custom */
        $('.pxl-swiper-arrow').parents('.pxl-swiper-sliders').addClass('pxl--hide-arrow');
    ...
    $(window).on('elementor/frontend/init', function() {
        ...
        elementorFrontend.hooks.addAction('frontend/element_ready/pxl_slide.default', pxl_swiper_handler);
    });
})(jQuery);